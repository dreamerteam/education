	...
	<div id="accordion">
		...
		<div style="padding: 5px 3px; overflow: hidden;">
			<ul class="nav nav-list">
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/courseType/list')">列表</a></li>
		...
		<div style="padding: 5px 3px; overflow: hidden;">
			<ul class="nav nav-list">
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/course/list')">课程列表</a></li>
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/course/lessionList')">开课列表</a></li>
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/course/list?caudit=0')">未审核</a></li>
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/course/list?caudit=10')">待审核</a></li>
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/course/list?caudit=20')">通过审核</a></li>
				<li class="pagination-centered"><a href="javascript:reloadMain('${contextPath}/manage/course/list?caudit=30')">未通过审核</a></li>
