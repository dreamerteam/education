...
<div class="well">
	<form action="${contextPath }/course/add" method="post" class="form-horizontal" id="addForm">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="courseType" id="courseType" placeholder="课程类型" class="validate[required]"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea rows="" cols="" name="cdescription" id="cdescription" class="validate[maxSize3[500]]"></textarea>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
