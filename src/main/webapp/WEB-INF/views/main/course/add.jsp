...
<body id="page">
<div class="well">
	<form action="${contextPath }/course/add" method="post" class="form-horizontal" id="addForm">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="cname" id="cname" placeholder="课程名称" class="validate[required,maxSize3[36]]" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label"><div class="inline" style="color: red;"> * </div>课程类型：</label>
			<div class="controls">
				<input type="text" name="utypename" id="utypename" placeholder="课程类型" class="validate[required,maxSize3[36]]"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">课程简介：</label>
			<div class="controls">
				<input type="text" name="cdescription" id="cdescription" placeholder="课程简介" />
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
...
var page = $("#page");
$(function(){
	autoComplete(true, $("#utypename"), courseType, $("utypeid"), null, null);
