...
<div class="well">
	<form action="${contextPath }/course/update" method="post" class="form-horizontal" id="editForm">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="utypename" id="utypename" placeholder="课程类型" class="validate[required,maxSize3[36]]" value="<c:out value="${courseResponse.utypename }"/>"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">课程简介：</label>
			<div class="controls">
				<input type="text" name="cdescription" id="cdescription" placeholder="课程简介" value="<c:out value="${courseResponse.cdescription }"/>"/>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
