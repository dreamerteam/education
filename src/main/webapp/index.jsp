		...
		<div class="row-fluid">
			<div class="span4" align="center">
				 <a id="modal" href="#modal-container" role="button" data-toggle="modal">
				 	<img src="${contextPath }/web/images/sign_in.jpg"/>
				 </a>
			</div>
			<div class="span4" align="center">
				 <a href="#login" data-toggle="modal">
				 	<img src="${contextPath }/web/images/sign_up.jpg"/>
				 </a>
			</div>
			<div class="span4" align="center">
				 <a href="${contextPath }/web/index">
				 	<img src="${contextPath }/web/images/enter.jpg"/>
				 </a>
			</div>
		</div>
		<!-- 登录 -->
